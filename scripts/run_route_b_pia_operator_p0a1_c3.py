...
def main() -> None:
    p = argparse.ArgumentParser(description="SCP-Branch P0a.1 C3 hetero-associative discriminative closed-form probe")
    p.add_argument("--datasets", type=str, default="natops")
    p.add_argument("--seeds", type=str, default="1")
    p.add_argument("--out-root", type=str, default="out/_active/verify_route_b_pia_operator_p0a1_c3_20260401_smoke")
    ...
    for dataset in datasets:
        for seed in seeds:
            ...
            anchor_rows_all.extend(_bipolar_anchor_diag_rows(dataset, seed, "c3_bipolar_discriminative_weighted_a2r", op_c3))
            ...
            c3_train, c3_val, c3_test, c3_summary, c3_state, after_c3_diag = _run_a2r_arm(op_c3, "c3_bipolar_discriminative_weighted_a2r")
            ...
            _write_json(
                os.path.join(seed_dir, "pia_operator_p0a1_c3_result.json"),
                {
                    ...
                    "c3_bipolar_discriminative_weighted_a2r": {"test_macro_f1": float(c3_test_metrics["macro_f1"]), "summary": dict(c3_summary), "meta": dict(c3_meta)},
            ...
            per_seed_rows.append(
                {
                    ...
                    "c3_bipolar_discriminative_weighted_a2r_test_macro_f1": float(c3_test_metrics["macro_f1"]),
            ...
            for stage_name, diag in [
                ...
                ("after_c3_bipolar_discriminative_weighted_a2r", after_c3_diag),
            ]:
            ...
            score_specs = [
                ...
                ("c3_bipolar_discriminative_weighted_a2r", c3_train_metrics, c3_val_metrics, c3_test_metrics),
            ]
            ...
            for summary in [c0_summary, c2_summary, c3_summary]:
    ...
    config_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_config_table.csv")
    per_seed_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_per_seed.csv")
    structure_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_structure_diagnostics.csv")
    score_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_score_diagnostics.csv")
    response_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_response_diagnostics.csv")
    anchor_csv = os.path.join(args.out_root, "pia_operator_p0a1_c3_anchor_diagnostics.csv")
    conclusion_md = os.path.join(args.out_root, "pia_operator_p0a1_c3_conclusion.md")
    ...
    for dataset in datasets:
        ...
        lines.append(f"- `c3_bipolar_discriminative_weighted_a2r`: {_format_mean_std(ds['c3_bipolar_discriminative_weighted_a2r_test_macro_f1'].tolist())}")
    ...
    print(f"[pia-operator-c3] wrote {config_csv}")
    print(f"[pia-operator-c3] wrote {per_seed_csv}")
    print(f"[pia-operator-c3] wrote {structure_csv}")
    print(f"[pia-operator-c3] wrote {score_csv}")
    print(f"[pia-operator-c3] wrote {response_csv}")
    print(f"[pia-operator-c3] wrote {anchor_csv}")
    print(f"[pia-operator-c3] wrote {conclusion_md}")
