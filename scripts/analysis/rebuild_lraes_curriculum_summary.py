...
from scripts.legacy_phase.run_phase15_lraes_curriculum_probe import (
    _entropy_from_probs,
    _format_mean_std,
    _result_label,
    _solver_comment,
...
from scripts.legacy_phase.run_phase15_mainline_freeze import _summarize_dir_profile
