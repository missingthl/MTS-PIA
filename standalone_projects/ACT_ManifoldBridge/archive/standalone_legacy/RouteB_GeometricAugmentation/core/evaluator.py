...
from core.types import BridgeResult, EvaluatorPosterior, TargetRoundState
# from utils.run_bridge_curriculum_pilot import _fit_raw_minirocket  # Delaying this to avoid dependency bloom
...
def evaluate_bridge(
    ...
    *,
    ...
    try:
        from utils.run_bridge_curriculum_pilot import _fit_raw_minirocket
    except ImportError:
        raise ImportError("MiniRocket evaluation requires 'utils.run_bridge_curriculum_pilot' and its legacy dependencies.")
