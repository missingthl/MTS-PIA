...
# Pilot7 Backbone Robustness: ModernTCN
# Protocol: CSTA-U5 Final20 config, but limited to Pilot7 datasets
# Output: results/backbone_robustness_moderntcn_v1/moderntcn_s123

ARMS="csta_topk_uniform_top5"
OUT_ROOT=${OUT_ROOT:-"standalone_projects/ACT_ManifoldBridge/results/backbone_robustness_moderntcn_v1/moderntcn_s123"}
SEEDS=${SEEDS:-"1,2,3"}
BACKBONE=${BACKBONE:-"moderntcn"}
EPOCHS=${EPOCHS:-30}
...
echo "=== Pilot7 Backbone Robustness: ModernTCN ==="
echo "Arms: $ARMS"
echo "Out:  $OUT_ROOT"
echo "GPUs: $GPUS"
...
echo "=== Pilot7 ModernTCN complete: $OUT_ROOT ==="
