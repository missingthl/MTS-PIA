...
# Final20 minimal baseline set for paper main table.
# Methods: random_cov_state, pca_cov_state, dba_sameclass, raw_aug_jitter
# Protocol: identical to run_csta_pia_final20.sh
# Output: results/final20_minimal_baseline_v1/resnet1d_s123
# LOCKED roots: csta_pia_final20 and wdba_final20 are NOT touched.

ARMS="random_cov_state,pca_cov_state,dba_sameclass,raw_aug_jitter"
OUT_ROOT=${OUT_ROOT:-"standalone_projects/ACT_ManifoldBridge/results/final20_minimal_baseline_v1/resnet1d_s123"}
SEEDS=${SEEDS:-"1,2,3"}
...
echo "=== Final20 Minimal Baseline Runner ==="
echo "Arms: $ARMS"
echo "Out:  $OUT_ROOT"
echo "GPUs: $GPUS"
...
echo "=== Final20 minimal baseline complete: $OUT_ROOT ==="
