...
P0_CANDIDATE_AUDIT_COLUMNS = [
    ...
    "template_response_top1",
    "template_response_top5_mean",
    "template_response_gap_top1_top5",
    "template_response_entropy",
    "selected_template_rank",
    "selected_template_response_abs",
    "gamma_requested",
    "gamma_used",
    "gamma_used_ratio",
    "eta_safe",
    "direction_norm",
    "pre_safe_displacement_norm",
    "post_safe_displacement_norm",
    "z_displacement_norm",
    "safe_upper_bound",
    "safe_radius_ratio",
    "safe_clip_flag",
        ...
        out.append(
            {
                ...
                **operator_meta,
                ...
                "template_response_top1": _to_float(row.get("template_response_top1", np.nan)),
                "template_response_top5_mean": _to_float(row.get("template_response_top5_mean", np.nan)),
                "template_response_gap_top1_top5": _to_float(row.get("template_response_gap_top1_top5", np.nan)),
                "template_response_entropy": _to_float(row.get("template_response_entropy", np.nan)),
                "selected_template_rank": _to_int(row.get("selected_template_rank", template_rank)),
                "selected_template_response_abs": _to_float(row.get("selected_template_response_abs", response_abs)),
                "gamma_requested": _to_float(row.get("gamma_requested", np.nan)),
                "gamma_used": gamma_used,
                "gamma_used_ratio": _to_float(row.get("gamma_used_ratio", np.nan)),
                "eta_safe": np.nan if eta_safe is None else float(eta_safe),
                "direction_norm": direction_norm,
                "pre_safe_displacement_norm": _to_float(row.get("pre_safe_displacement_norm", np.nan)),
                "post_safe_displacement_norm": _to_float(row.get("post_safe_displacement_norm", np.nan)),
...
def summarize_candidate_audit(df: pd.DataFrame) -> Dict[str, object]:
    ...
    numeric_aggs = {
        ...
        "template_response_top1": "template_response_top1_mean_audit",
        "template_response_top5_mean": "template_response_top5_mean_audit",
        "template_response_gap_top1_top5": "template_response_gap_top1_top5_mean_audit",
        "template_response_entropy": "template_response_entropy_mean_audit",
        "selected_template_response_abs": "selected_template_response_abs_mean_audit",
        "gamma_requested": "gamma_requested_mean_audit",
        "gamma_used": "gamma_used_mean_audit",
        "gamma_used_ratio": "gamma_used_ratio_mean_audit",
        "pre_safe_displacement_norm": "pre_safe_displacement_norm_mean_audit",
        "post_safe_displacement_norm": "post_safe_displacement_norm_mean_audit",
